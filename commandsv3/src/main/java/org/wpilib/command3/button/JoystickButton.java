...
public class JoystickButton extends Trigger {
   ...
   */
  public JoystickButton(Scheduler scheduler, Context context, GenericHID joystick, int buttonNumber) {
    super(scheduler, context, () -> joystick.getRawButton(buttonNumber));
    requireNonNullParam(joystick, "joystick", "JoystickButton");
  }

  /**
   * Creates a joystick button for triggering commands. Uses the default scheduler and teleop context.
   *
   * @param joystick The GenericHID object that has the button (e.g. Joystick, KinectStick, etc)
   * @param buttonNumber The button number (see {@link GenericHID#getRawButton(int) }
   */
  ...
  /**
   * Creates a joystick button for triggering commands with the given context. Uses the default scheduler.
   *
   * @param context The context that must be true for edges to be considered
   * @param joystick The GenericHID object that has the button (e.g. Joystick, KinectStick, etc)
   * @param buttonNumber The button number (see {@link GenericHID#getRawButton(int) }
