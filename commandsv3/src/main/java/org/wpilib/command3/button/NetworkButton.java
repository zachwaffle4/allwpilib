...
public class NetworkButton extends Trigger {
  ...
  /**
   * Creates a NetworkButton that commands can be bound to. Uses the default scheduler and universal context.
   *
  ...
  /**
   * Creates a NetworkButton that commands can be bound to with the given context. Uses the default scheduler.
   *
   * @param context The context that must be true for edges to be considered
   * @param sub The boolean subscriber that provides the value.
   */
