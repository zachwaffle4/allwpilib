...
public class POVButton extends Trigger {
   ...
   */
  public POVButton(Scheduler scheduler, Context context, GenericHID joystick, POVDirection angle, int povNumber) {
  ...
  /**
   * Creates a POV button for triggering commands. By default, acts on POV 0. Uses the default scheduler and teleop context.
   *
   * @param joystick The GenericHID object that has the POV
   * @param angle The desired angle
   */
  ...
  /**
   * Creates a POV button for triggering commands with the given context. Uses the default scheduler.
   *
   * @param context The context that must be true for edges to be considered
   * @param joystick The GenericHID object that has the POV
   * @param angle The desired angle
